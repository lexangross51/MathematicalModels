...
public class Viewport2DRenderer
{
    ...
    private readonly Objects.Axis.Axis _horizontalAxis;
    private readonly Objects.Axis.Axis _verticalAxis;
    ...
    public Viewport2DRenderer(RenderSettings renderSettings, Camera2D camera)
    {
        ...
        _horizontalAxis = new Objects.Axis.Axis("X");
        _verticalAxis = new Objects.Axis.Axis("Y");
    ...
    private double CalculateStepAxis(double begin, double end, double measure)
    {
        ...
        var fontSize = TextPrinter.TextMeasure(Objects.Axis.Axis.TemplateCaption, Font).Width * dH / hh;
